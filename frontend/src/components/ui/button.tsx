...
// 尺寸参照 huntifyai 的设计系统实测值：主 CTA 40px / 大 CTA 44-48px，水平内边距 16-32px。
// 原来 default 是 h-8 + px-2.5（32px 高、10px 内边距），文字贴着边框，在薪资这种场景显得局促；
// lg 的 padding 还和 default 一样，等于没有真正的大号可用。
